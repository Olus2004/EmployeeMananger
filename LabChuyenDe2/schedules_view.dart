...
class SchedulesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.white, elevation: 0, title: const Text('Bảng công', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF1E293B)))),
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const Divider(height: 1),
              _aRow('Nguyễn Văn A', '1', 'Hà Nội', 'Alpha', 1, '07:30', '18:30'),
              _aRow('Trần Thị B', '2', 'TP.HCM', 'Beta', 1, '08:00', '19:00'),
              _aRow('Lee Wei', '3', 'Beijing', 'Gamma', 0, '', ''),
              _aRow('Phạm Văn C', '4', 'Đà Nẵng', 'Delta', 2, '', ''),
              _aRow('Zhang Min', '5', 'Shanghai', 'Epsilon', 1, '19:30', '06:30'),
              _aRow('Lê Hoàng D', '6', 'Hà Nội', 'Alpha', 3, '', ''),
            ]),
          ),
        ]),
      ),
